...
# Generated: Fri Feb 26 16:15:49 2010
##################################################
...
class pll(gr.top_block):
	...
	def __init__(self):
		...
		self.gr_phase_compute_cf_0 = gr.phase_compute_cf()
		...
		self.connect((self.gr_float_to_complex_1, 0), (self.gr_phase_compute_cf_0, 1))
		self.connect((self.gr_float_to_complex_0, 0), (self.gr_phase_compute_cf_0, 0))
		self.connect((self.gr_phase_compute_cf_0, 0), (self.gr_file_sink_0, 0))
